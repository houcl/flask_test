...
gTLDS = {
    ...
    'catholic' : True,
    'post' : True, 'xxx' : True, 'co.in': True, 'co.uk' : True, 'me' : True,
    'io' : True
    }
...
if __name__ == '__main__':
  ...
  assert query_domain_from_url('http://www.ibtimes.co.in') == 'ibtimes.co.in'
  assert query_domain_from_url('http://www.telegraph.co.uk') == 'telegraph.co.uk'
  assert query_domain_from_url('https://brightside.me') == 'brightside.me'
  assert query_domain_from_url('http://www.techinsider.io') == 'techinsider.io'
  print 'TEST [OK]'
